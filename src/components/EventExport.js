...
const EventExport = ({ events, containerRef, isOpen, onClose }) => {
  ...
  const showCustomRange = selectedRange === 'custom';

  return (
    <div className="event-export-modal-overlay" onClick={onClose}>
      <div className="event-export-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="export-content">
          <div className="event-count-badge">
            {filteredEvents.length} event{filteredEvents.length !== 1 ? 's' : ''} selected
          </div>
